...
## Metadata
- Scorecard ID: SCORE-20260217-44
- SOP ID: SOP-20260217-44
- Date: 2026-02-17
- Owner: yizhi
- Constraints summary: 在控制预算与滥用风险的前提下迭代激励参数并验证效果。

## Candidate Options
| Option | Description | Notes |
|---|---|---|
| A | 假设建模 -> 小范围试行 -> 效果评估 -> 参数落地。 | 在质量与效率间平衡 |
...
|---|---|---|---|---|
| 激励参数调整必须先做风险门禁再执行。 | DORA:https://dora.dev/ | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |
| 激励参数调整必须先做风险门禁再执行。 | FATF Virtual Assets Guidance:https://www.fatf-gafi.org/en/publications/Fatfrecommendations/Guidance-rba-virtual-assets-2021.html | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |

## Best Method Decision
- Selected method: Option A (假设建模 -> 小范围试行 -> 效果评估 -> 参数落地。)
...
|---|---|---|---|---|
| 参数评审表 | 核心执行 | 预算浪费率下降 >=25%；激励有效转化提升 >=20% | 工具依赖增加 | 回滚参数到上一稳定版本并冻结高风险激励 |
