...
## Metadata
- Scorecard ID: SCORE-20260217-49
- SOP ID: SOP-20260217-49
- Date: 2026-02-17
- Owner: yizhi
- Constraints summary: 在危机场景下保持对外信息一致、透明、可验证，控制二次伤害。

## Candidate Options
| Option | Description | Notes |
|---|---|---|
| A | 事实确认 -> 首次公告 -> 周期更新 -> 复盘澄清。 | 在质量与效率间平衡 |
...
|---|---|---|---|---|
| 危机沟通必须事实先行、节奏可控、口径统一。 | CDC CERC:https://emergency.cdc.gov/cerc/ | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |
| 危机沟通必须事实先行、节奏可控、口径统一。 | CISA Incident Response Playbooks:https://www.cisa.gov/news-events/news/cisa-releases-updated-cybersecurity-incident-and-vulnerability-response-playbooks | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |

## Best Method Decision
- Selected method: Option A (事实确认 -> 首次公告 -> 周期更新 -> 复盘澄清。)
...
|---|---|---|---|---|
| 公告模板 | 核心执行 | 信息一致性提升 >=30%；谣言扩散窗口缩短 >=25% | 工具依赖增加 | 下架错误公告并发布更正说明 |
