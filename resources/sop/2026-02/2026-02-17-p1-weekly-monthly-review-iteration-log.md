...
|---|---|---|---|---|---|
| Cycle time | 85 min | 58 min | -27 min | <= 60 分钟完成周复盘 | pass |
| First-pass yield | 59% | 90% | +31 pp | >= 90 percent 复盘首轮完成规则更新 | pass |
| Rework rate | 34% | 13% | -21 pp | <= 15 percent 规则需二次修订 | pass |
| Adoption rate | 40% | 100% | +60 pp | 100 percent 周月复盘使用本SOP | pass |
...
## Findings
- What improved: 复盘可执行性显著提升
- What degraded: 一次数据同步延迟
- Root causes: 指标采集时点不一致
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-p1-weekly-monthly-review-sop.md
