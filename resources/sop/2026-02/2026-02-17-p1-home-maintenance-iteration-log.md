...
|---|---|---|---|---|---|
| Cycle time | 44 min | 28 min | -16 min | <= 30 分钟完成周维护计划 | pass |
| First-pass yield | 63% | 91% | +28 pp | >= 90 percent 周期任务按期启动 | pass |
| Rework rate | 30% | 12% | -18 pp | <= 15 percent 任务需二次重排 | pass |
| Adoption rate | 43% | 100% | +57 pp | 100 percent 周期任务纳入清单 | pass |
...
## Findings
- What improved: 周期任务漏项率显著下降
- What degraded: 一次窗口被临时占用
- Root causes: 备选窗口规划不足
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-p1-home-maintenance-sop.md
