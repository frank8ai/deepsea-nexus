...
|---|---|---|---|---|---|
| Cycle time | 95 min | 58 min | -37 min | <= 60 分钟完成行前总检查 | pass |
| First-pass yield | 60% | 91% | +31 pp | >= 90 percent 出行关键清单首轮完成 | pass |
| Rework rate | 31% | 13% | -18 pp | <= 15 percent 行程需二次重排 | pass |
| Adoption rate | 38% | 100% | +62 pp | 100 percent 出行计划使用本SOP | pass |
...
## Findings
- What improved: 行前准备完整性提升
- What degraded: 一次临时行程变更造成重排
- Root causes: 外部交通不确定性
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-p2-travel-readiness-sop.md
