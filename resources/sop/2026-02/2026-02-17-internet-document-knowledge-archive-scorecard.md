...
## Metadata
- Scorecard ID: SCORE-20260217-36
- SOP ID: SOP-20260217-36
- Date: 2026-02-17
- Owner: yizhi
- Constraints summary: 保证关键决策与变更可追溯、可检索、可复用。

## Candidate Options
| Option | Description | Notes |
|---|---|---|
| A | 模板化记录 + 标签索引 + 月度审计。 | 在质量与效率间平衡 |
...
|---|---|---|---|---|
| 关键决策必须沉淀为可检索文档并绑定证据。 | NIST Information Quality:https://www.nist.gov/director/nist-information-quality-standards | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |
| 关键决策必须沉淀为可检索文档并绑定证据。 | PRISMA-S:https://systematicreviewsjournal.biomedcentral.com/articles/10.1186/s13643-020-01542-z | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |

## Best Method Decision
- Selected method: Option A (模板化记录 + 标签索引 + 月度审计。)
...
|---|---|---|---|---|
| ADR模板 | 核心执行 | 召回命中率提升 >=25%；失链率下降 >=30% | 工具依赖增加 | 回滚错误条目并恢复上一版索引 |
