...
## Metadata
- Scorecard ID: SCORE-20260217-35
- SOP ID: SOP-20260217-35
- Date: 2026-02-17
- Owner: yizhi
- Constraints summary: 用风险看板提前暴露阻塞并保持项目节奏可控。

## Candidate Options
| Option | Description | Notes |
|---|---|---|
| A | 周节奏更新 -> 风险分级 -> 升级处置 -> 复盘写回。 | 在质量与效率间平衡 |
...
|---|---|---|---|---|
| 项目看板必须同步风险热度和阻塞责任人。 | DORA:https://dora.dev/ | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |
| 项目看板必须同步风险热度和阻塞责任人。 | NIST SSDF:https://csrc.nist.gov/pubs/sp/800/218/final | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |

## Best Method Decision
- Selected method: Option A (周节奏更新 -> 风险分级 -> 升级处置 -> 复盘写回。)
...
|---|---|---|---|---|
| 项目看板 | 核心执行 | 阻塞发现提前量提升 >=30%；延期率下降 >=20% | 工具依赖增加 | 回退到上周排期并重平衡关键路径 |
