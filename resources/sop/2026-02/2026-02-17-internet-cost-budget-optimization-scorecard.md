...
## Metadata
- Scorecard ID: SCORE-20260217-39
- SOP ID: SOP-20260217-39
- Date: 2026-02-17
- Owner: yizhi
- Constraints summary: 在不牺牲关键结果的前提下持续降低无效成本并优化预算配置。

## Candidate Options
| Option | Description | Notes |
|---|---|---|
| A | 成本拆分 -> 价值评估 -> 优先级执行 -> ROI复盘。 | 在质量与效率间平衡 |
...
|---|---|---|---|---|
| 成本优化必须以结果价值为前提，避免“省钱伤业务”。 | AWS Cost Optimization Pillar:https://docs.aws.amazon.com/wellarchitected/latest/cost-optimization-pillar/welcome.html | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |
| 成本优化必须以结果价值为前提，避免“省钱伤业务”。 | FinOps Framework:https://www.finops.org/framework/ | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |

## Best Method Decision
- Selected method: Option A (成本拆分 -> 价值评估 -> 优先级执行 -> ROI复盘。)
...
|---|---|---|---|---|
| 成本看板 | 核心执行 | 单位结果成本下降 >=20%；预算偏差下降 >=25% | 工具依赖增加 | 回滚关键资源降配并恢复容量 |
