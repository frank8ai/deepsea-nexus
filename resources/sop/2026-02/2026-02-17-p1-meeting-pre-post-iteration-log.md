...
|---|---|---|---|---|---|
| Cycle time | 32 min | 19 min | -13 min | <= 20 分钟会前准备 | pass |
| First-pass yield | 68% | 91% | +23 pp | >= 90 percent 会议首轮达成明确结论 | pass |
| Rework rate | 30% | 12% | -18 pp | <= 15 percent 行动项需二次澄清 | pass |
| Adoption rate | 44% | 100% | +56 pp | 100 percent 关键会议使用本SOP | pass |
...
## Findings
- What improved: 会议输出清晰度和行动项完成率提升
- What degraded: 一次跨团队会议超时
- Root causes: 议题优先级排序不足
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-p1-meeting-pre-post-sop.md
