...
- Date: 2026-02-17
- SOP: `resources/sop/2026-02/2026-02-17-study-goal-decomposition-sop.md`
- SOP Name: 学习目标拆解
...
- Best Practice evidence rows: 目标可测性 <- SOP_PRINCIPLES.md；分层拆解 <- agent/patterns/sop-factory.md；学习技术证据 <- https://pubmed.ncbi.nlm.nih.gov/26173288/
- Best Method score: Winner B=4.40, Runner-up=3.80, Margin=0.60, Hard constraints=passed
- Best Tool evidence: gain[学习目标卡:清晰度提升 >=30%；进度表:偏差发现提前 >=25%；strict validator:漏项减少 >=35%], rollback[学习目标卡->模板简化；进度表->周复盘强制更新；strict validator->草稿迭代后发布]
