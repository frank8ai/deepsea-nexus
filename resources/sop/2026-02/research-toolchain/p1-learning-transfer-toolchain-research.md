...
- Date: 2026-02-17
- SOP: `resources/sop/2026-02/2026-02-17-p1-learning-transfer-sop.md`
- SOP Name: 学习迁移与应用实践
...
- Best Practice evidence rows: 检索与应用结合 <- https://pubmed.ncbi.nlm.nih.gov/26173288/；结果导向 <- SOP_PRINCIPLES.md；闭环回写 <- agent/patterns/sop-factory.md
- Best Method score: Winner B=4.40, Runner-up=3.80, Margin=0.60, Hard constraints=passed
- Best Tool evidence: gain[迁移任务清单:迁移率提升 >=30%；实战练习仓库:复盘质量提升 >=25%；迁移日志:闭环速度提升 >=20%], rollback[迁移任务清单->拆小任务；实战练习仓库->周归档；迁移日志->最小字段强制]
