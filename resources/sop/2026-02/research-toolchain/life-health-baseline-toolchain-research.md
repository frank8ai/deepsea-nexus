...
- Date: 2026-02-17
- SOP: `resources/sop/2026-02/2026-02-17-life-health-baseline-sop.md`
- SOP Name: 生活健康基线
...
- Best Practice evidence rows: 运动基线 <- https://www.cdc.gov/physical-activity-basics/guidelines/index.html；睡眠基线 <- https://www.cdc.gov/sleep/about/index.html；结果闭环 <- SOP_PRINCIPLES.md
- Best Method score: Winner B=4.40, Runner-up=3.80, Margin=0.60, Hard constraints=passed
- Best Tool evidence: gain[基线目标表:清晰度提升 >=30%；日追踪打卡:连续执行率提升 >=25%；周复盘模板:恢复速度提升 >=20%], rollback[基线目标表->每周校准；日追踪打卡->仅跟踪关键项；周复盘模板->强制1-3规则]

## Three-Optimal Conclusion
- 最佳实践: 睡眠、运动、饮食三基线优先，先稳定再优化
- 最佳方法: 周计划 + 日追踪 + 连续偏离触发纠偏
