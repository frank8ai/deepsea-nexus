...
## Metadata
- Scorecard ID: SCORE-20260217-47
- SOP ID: SOP-20260217-47
- Date: 2026-02-17
- Owner: yizhi
- Constraints summary: 降低空投作弊和资源浪费，保障激励公平性。

## Candidate Options
| Option | Description | Notes |
|---|---|---|
| A | 规则检测 -> 风险分层 -> 冻结复核 -> 申诉复审。 | 在质量与效率间平衡 |
...
|---|---|---|---|---|
| 空投执行前必须完成反女巫检测并保留申诉通道。 | Gitcoin Passport Docs:https://docs.passport.xyz/ | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |
| 空投执行前必须完成反女巫检测并保留申诉通道。 | NIST Information Quality:https://www.nist.gov/director/nist-information-quality-standards | source-backed | 降低关键失败风险 | 执行僵化或成本上升 |

## Best Method Decision
- Selected method: Option A (规则检测 -> 风险分层 -> 冻结复核 -> 申诉复审。)
...
|---|---|---|---|---|
| 女巫检测规则引擎 | 核心执行 | 作弊发放比例下降 >=35%；申诉处理时长下降 >=20% | 工具依赖增加 | 冻结名单回滚并恢复待审状态 |
