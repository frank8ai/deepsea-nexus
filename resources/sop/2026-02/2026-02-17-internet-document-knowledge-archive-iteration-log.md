...
## Metadata
- Log ID: ITER-20260217-36
- SOP ID: SOP-20260217-36
- SOP Name: 文档与知识归档（互联网）
- Owner: yizhi
...
|---|---|---|---|---|---|
| Cycle time | 102 min | 69 min | improved | <= 75 分钟完成单次流程执行 | pass |
| First-pass yield | 61% | 91% | improved | >= 90 percent 场景首轮通过 | pass |
| Rework rate | 33% | 14% | improved | <= 15 percent 需要二次修正 | pass |
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-internet-document-knowledge-archive-sop.md
