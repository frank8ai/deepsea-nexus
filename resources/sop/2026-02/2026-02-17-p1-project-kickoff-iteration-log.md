...
|---|---|---|---|---|---|
| Cycle time | 3.5 day | 1.8 day | -1.7 day | <= 2 个工作日完成启动包 | pass |
| First-pass yield | 61% | 90% | +29 pp | >= 90 percent 启动评审一次通过 | pass |
| Rework rate | 36% | 14% | -22 pp | <= 15 percent 启动包二次返工 | pass |
| Adoption rate | 35% | 100% | +65 pp | 100 percent 新项目使用本SOP | pass |
...
## Findings
- What improved: 项目启动清晰度和里程碑确定性提升
- What degraded: 一次外部依赖延迟
- Root causes: 依赖可用性评估偏乐观
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-p1-project-kickoff-sop.md
