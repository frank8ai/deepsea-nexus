...
|---|---|---|---|---|---|
| Cycle time | 88 minutes | 58 minutes | -30 minutes | <= 60 minutes to stable containment | pass |
| First-pass yield | 64% | 91% | +27 pp | >= 90 percent incidents classified correctly on first pass | pass |
| Rework rate | 32% | 14% | -18 pp | <= 15 percent incidents require reopen | pass |
| Adoption rate | 51% | 100% | +49 pp | 100 percent incidents logged with this SOP | pass |
...
## Findings
- What improved: containment speed and severity consistency improved
- What degraded: one incident needed secondary containment
- Root causes: incomplete blast-radius mapping at initial triage
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-work-incident-response-sop.md
