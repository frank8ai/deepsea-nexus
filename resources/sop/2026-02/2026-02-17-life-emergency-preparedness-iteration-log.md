...
|---|---|---|---|---|---|
| Cycle time | 54 minutes | 34 minutes | -20 minutes | <= 35 minutes per monthly run | pass |
| First-pass yield | 65% | 91% | +26 pp | >= 90 percent critical items in ready state | pass |
| Rework rate | 30% | 10% | -20 pp | <= 10 percent unresolved critical gaps | pass |
| Adoption rate | 39% | 100% | +61 pp | 100 percent months complete one drill | pass |
...
## Findings
- What improved: preparedness coverage and gap closure improved
- What degraded: one drill exceeded planned window
- Root causes: contact tree update was delayed by one day
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-life-emergency-preparedness-sop.md
