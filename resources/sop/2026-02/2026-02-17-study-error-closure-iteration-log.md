...
|---|---|---|---|---|---|
| Cycle time | 58 minutes | 39 minutes | -19 minutes | <= 40 minutes per error-closure batch | pass |
| First-pass yield | 63% | 88% | +25 pp | >= 87 percent high-frequency errors show mastery lift | pass |
| Rework rate | 34% | 14% | -20 pp | <= 15 percent errors reopen after closure | pass |
| Adoption rate | 46% | 100% | +54 pp | 100 percent sessions with errors trigger this SOP | pass |
...
## Findings
- What improved: weak-point recovery and root-cause visibility improved
- What degraded: one category reopened next day
- Root causes: incorrect root-cause tagging at first pass
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-study-error-closure-sop.md
