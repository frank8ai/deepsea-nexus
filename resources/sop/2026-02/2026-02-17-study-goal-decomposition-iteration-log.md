...
|---|---|---|---|---|---|
| Cycle time | 44 minutes | 28 minutes | -16 minutes | <= 30 minutes per goal decomposition | pass |
| First-pass yield | 68% | 92% | +24 pp | >= 90 percent goals have measurable milestones | pass |
| Rework rate | 30% | 11% | -19 pp | <= 12 percent milestones need major re-scope | pass |
| Adoption rate | 35% | 100% | +65 pp | 100 percent new goals use this SOP | pass |
...
## Findings
- What improved: goal clarity and weekly execution fit improved
- What degraded: one topic had over-fragmented milestones
- Root causes: initial complexity estimate was too optimistic
...
## Links
- SOP document: resources/sop/2026-02/2026-02-17-study-goal-decomposition-sop.md
